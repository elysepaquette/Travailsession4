...
#lier ce sript et injection_données.R
bd_liens <- dbGetQuery(tables.db, 'SELECT*FROM Liens')
bd_cours <- dbGetQuery(tables.db, 'SELECT*FROM Cours')
bd_etudiants <- dbGetQuery(tables.db, 'SELECT*FROM Etudiants')
